module.exports = {
  ...
  themeConfig: {
    ...
    sidebar: {
			...
			'/config/' : ['main','components','filters','include','properties','config','inputs','processors','transporters'],
		},
    nav: [
		...
		locales : {
			...
			'/es/' : {
				...
				sidebar: {
					...
					'/es/config/' : ['main','components','filters','include','properties','config','inputs','processors','transporters'],
				},
				nav : [
